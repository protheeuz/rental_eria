                                            ...
                                            <div class="panel-body bk-info text-light">
												...
												?>
                                                    <div class="stat-panel-number h1 ">
                                                        <?php echo htmlentities($bayar);?></div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-success text-light">
												...
												?>
                                                    <div class="stat-panel-number h1 ">
                                                        <?php echo htmlentities($konfir);?></div>
                                                    <div class="stat-panel-title text-uppercase">Menunggu Konfirmasi
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-info text-light">
												...
												?>
                                                    <div class="stat-panel-number h1 ">
                                                        <?php echo htmlentities($belum);?></div>
                                                    <div class="stat-panel-title text-uppercase">Belum Dikembalikan
                                                    </div>
                                                </div>
                                            </div>
