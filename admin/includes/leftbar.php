	<nav class="ts-sidebar">
		<ul class="ts-sidebar-menu">
			...
			<li><a href="#"><i class="fa fa-exchange"></i> Tracking</a>
				<ul class="ts-sidebar-menu">
					<li><a href="tambah-data-gps.php"><i class="fa fa-plus-circle"></i> Tambah Data GPS</a></li>
					<li><a href="tracking.php"><i class="fa fa-map-marker"></i> Tracking Kendaraan</a></li>
				</ul>
			</li>
